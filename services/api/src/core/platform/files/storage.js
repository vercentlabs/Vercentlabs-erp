...
//   (unset)                     local outside production; in production the
//                               store is REQUIRED and uploads fail closed with
//                               503 until Prompt 6 wires the real provider.
