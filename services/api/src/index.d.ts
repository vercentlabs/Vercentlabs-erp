...
export function transitionProcurementReturnWithStockMovement(client: QueryClient, procurementContext: any, stockContext: any, returnId: string, action: string, input?: Record<string, unknown>): Promise<any>;
