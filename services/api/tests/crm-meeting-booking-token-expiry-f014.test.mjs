...
test("F014: the public booking cancel/reschedule route is the ONLY code path that resolves cancellation_token/reschedule_token — no bypass exists", () => {
  const route = [
    read("apps/web/src/app/api/crm/public/meetings/bookings/[token]/route.ts"),
    read("apps/web/src/modules/crm/seller-activity-and-follow-up-workspace/route-handlers/public-meeting-booking-management.ts"),
  ].join("\n");
