...
const detail = read("../src/modules/crm/prospect-and-relationship-master-data/contact-detail-workspace.tsx");
const form = read("../src/modules/crm/prospect-and-relationship-master-data/contact-form-drawer.tsx");
