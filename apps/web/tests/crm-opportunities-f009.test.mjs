...
test("F009 web: Opportunities remains a reachable governed CRM resource", () => {
  const definition = read("apps/web/src/modules/crm/crm-data-operations-and-customization/resource-definitions/opportunity-pipeline.ts");
...
test("F009 backend: reopen is a controlled transition on the same governed stage endpoint, not a new bypass", () => {
  const backend = read("services/api/src/modules/crm/opportunity-and-pipeline-governance/opportunity-transitions.js") + read("services/api/src/modules/crm/opportunity-and-pipeline-governance/opportunity-operations.js");
