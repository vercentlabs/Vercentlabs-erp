...
test("F001 Wave 1 web: Kanban and detail lifecycle transitions send expectedUpdatedAt", () => {
  const board = read("src/modules/crm/prospect-and-relationship-master-data/leads-workspace.tsx") + read("src/modules/crm/prospect-and-relationship-master-data/lead-edit-panel.tsx");
  const detail = read("src/modules/crm/prospect-and-relationship-master-data/lead-detail-workspace.tsx") + read("src/modules/crm/prospect-and-relationship-master-data/lead-owner-dialog.tsx");
