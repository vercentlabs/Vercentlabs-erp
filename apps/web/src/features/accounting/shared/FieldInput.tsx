...
import type { AccountingOptions } from "@/features/accounting/shared/client";

export type OptionSource = "accounts" | "journals" | "customers" | "suppliers" | "bankAccounts" | "periods" | "postingAccounts" | "assetCategories";
...
export function resolveOptions(field: FieldDef, options: AccountingOptions | undefined): SelectOption[] {
...
export function FieldInput({ field, value, onChange, options }: { field: FieldDef; value: FieldValue | undefined; onChange: (value: FieldValue) => void; options?: AccountingOptions; values: Record<string, FieldValue> }) {
