...
export type OptionSource = "customers" | "categories" | "queues" | "slaPolicies" | "agents" | "products" | "entitlements";
...
export function resolveOptions(field: FieldDef, options: SupportOptions | undefined): SelectOption[] {
...
export function FieldInput({ field, value, onChange, options }: { field: FieldDef; value: FieldValue | undefined; onChange: (value: FieldValue) => void; options?: SupportOptions; values: Record<string, FieldValue> }) {
