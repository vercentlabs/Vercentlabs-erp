...
import type { AssetsOptions } from "@/features/assets/shared/client";

export type OptionSource = "categories" | "locations" | "assets" | "users" | "departments" | "costCenters" | "suppliers" | "campaigns" | "warranties" | "customers" | "accounts" | "sourceLines";
...
export function resolveOptions(field: FieldDef, options: AssetsOptions | undefined): SelectOption[] {
...
export function FieldInput({ field, value, onChange, options }: { field: FieldDef; value: FieldValue | undefined; onChange: (value: FieldValue) => void; options?: AssetsOptions; values: Record<string, FieldValue> }) {
