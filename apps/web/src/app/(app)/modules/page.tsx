...
export default async function ModulesPage() {
  ...
  const canManage = hasPermission(session, "modules.manage");
    ...
    <>
      <section className="page-heading">
        ...
        <div className="page-heading-summary">
          <span className="status-badge neutral">12 registered</span>
      ...
      <section className="module-grid" aria-label="ERP modules">
        {moduleCatalog.map((module, index) => {
          const moduleStatus = status.get(module.key) || "registered";
          return (
            <article className="module-card" key={module.key}>
              ...
              {canManage ? (
                ...
                <span className="module-readonly">View access only</span>
              )}
            </article>
          );
        })}
