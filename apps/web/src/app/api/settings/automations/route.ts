...
export async function GET(request: Request) {
  return workspaceRoute(request, { permission: CORE_PERMISSIONS.platformWorkflowsManage, action: "workflows.list" }, async ({ client, session }) =>
    ok({
...
export async function POST(request: Request) {
  return workspaceRoute(
    request,
    { permission: CORE_PERMISSIONS.platformWorkflowsManage, action: "workflows.create", auditDenial: true },
