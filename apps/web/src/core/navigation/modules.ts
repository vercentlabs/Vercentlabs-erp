...
export const moduleNavigation: ModuleNavigationGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/crm/leads", label: "Leads", icon: "crm", group: "Customers", permission: PERMISSIONS.crmView },
      { href: "/crm/accounts", label: "Accounts", icon: "companies", group: "Customers", permission: PERMISSIONS.crmView },
      { href: "/crm/contacts", label: "Contacts", icon: "users", group: "Customers", permission: PERMISSIONS.crmView },
      { href: "/crm/opportunities", label: "Opportunities", icon: "sales", group: "Pipeline", permission: PERMISSIONS.crmView },
      ...
      { href: "/crm/work", label: "My work", icon: "approvals", group: "Work", permission: PERMISSIONS.crmView, keywords: ["tasks", "calls", "meetings", "follow-ups", "inbox"] },
      { href: "/crm/activities", label: "Activity timeline", icon: "approvals", group: "Work", permission: PERMISSIONS.crmView, keywords: ["activity", "history"] },
      { href: "/crm/tasks", label: "Tasks", icon: "check", group: "Work", permission: PERMISSIONS.crmView, keywords: ["my work", "team queue", "todo"] },
      ...
      { href: "/crm/sales-teams", label: "Sales teams", icon: "teams", group: "Revenue operations", permission: PERMISSIONS.crmRevenueManage },
      { href: "/crm/territories", label: "Territories", icon: "branches", group: "Revenue operations", permission: PERMISSIONS.crmRevenueManage },
      { href: "/crm/quota-plans", label: "Quotas", icon: "audit", group: "Revenue operations", permission: PERMISSIONS.crmRevenueManage },
      { href: "/crm/settings", label: "CRM setup", icon: "settings", group: "Administration", permission: PERMISSIONS.crmSettingsManage },
    ],
  },
  {
    label: "Sales",
