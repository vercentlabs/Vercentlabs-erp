...
> = {
  ...
  "item-variants": {
    ...
    description:
      "Maintain SKU-level variants and attributes without duplicating the base item master.",
    group: "Products",
    managePermission: PERMISSIONS.itemsManage,
    columns: [
      { key: "sku", label: "SKU" },
      { key: "name", label: "Variant" },
      { key: "itemId", label: "Base item", optionsKey: "items" },
      { key: "barcode", label: "Barcode" },
      { key: "status", label: "Status", format: "status" },
    ],
    fields: [
      { name: "companyId", label: "Company scope", type: "select", optionsKey: "companies" },
      { name: "itemId", label: "Base item", type: "select", optionsKey: "items", required: true },
      { name: "sku", label: "Variant SKU", type: "text", required: true },
      { name: "name", label: "Variant name", type: "text", required: true },
      { name: "barcode", label: "Barcode", type: "text" },
      { name: "salesPrice", label: "Sales price", type: "number", step: "0.01" },
      { name: "purchasePrice", label: "Purchase price", type: "number", step: "0.01" },
      { name: "standardCost", label: "Standard cost", type: "number", step: "0.01" },
  ...
  "item-uom-conversions": {
    ...
    eyebrow: "Product measurement",
    description:
      "Maintain item-specific conversion factors used by Sales, Procurement and Stock calculations.",
    group: "Products",
    managePermission: PERMISSIONS.itemsManage,
    columns: [
      { key: "itemId", label: "Item", optionsKey: "items" },
      { key: "fromUomId", label: "From", optionsKey: "uoms" },
      { key: "toUomId", label: "To", optionsKey: "uoms" },
      { key: "conversionFactor", label: "Factor" },
      { key: "status", label: "Status", format: "status" },
    ],
    fields: [
      { name: "itemId", label: "Item", type: "select", optionsKey: "items", required: true },
      { name: "fromUomId", label: "From UOM", type: "select", optionsKey: "uoms", required: true },
      { name: "toUomId", label: "To UOM", type: "select", optionsKey: "uoms", required: true },
      { name: "conversionFactor", label: "Conversion factor", type: "number", step: "0.000001", required: true },
      { name: "status", label: "Status", type: "select", options: statusOptions },
    ],
  },
  "tax-categories": {
