...
export const PERMISSIONS = {
  ...
  crmRevenueManage: "crm.revenue.manage",
  crmAccountsManage: "crm.accounts.manage",
  crmPlaybooksManage: "crm.playbooks.manage",
  crmPrivacyManage: "crm.privacy.manage",
  crmDataQualityManage: "crm.data-quality.manage",
  crmIntegrationsManage: "crm.integrations.manage",
  crmAiManage: "crm.ai.manage",
