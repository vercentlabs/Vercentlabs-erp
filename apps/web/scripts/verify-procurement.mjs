...
markers("../../database/tenant/migrations/013_procurement_enterprise_completion.sql", [
  "procurement_document_links", "procurement_outbox_idempotency_uidx",
  "procurement_purchase_order_lines_parent_fk", "procurement_matching_records_parent_fk",
]);
...
markers("../../services/api/src/procurement/index.js", [
  "contentHash", "allocate", "procurement.view", "The creator cannot approve",
  "updateProcurementRecord", "awardSourcingEvent", "amendPurchaseOrder",
  "runProcurementMatch", "applyReceiptToOrder", "procurement_events",
  "procurement_outbox", "procurement_reporting_facts", "three-way", "four-way",
]);
markers("src/lib/procurement-validation.ts", [
  "parseProcurementCreate", "parseProcurementUpdate", "procurementMatchSchema",
  "purchase-orders", "sourcing-events", "match-exceptions",
]);
markers("src/components/procurement/procurement-workspace.tsx", [
  "ProcurementDashboard", "ProcurementResourceWorkspace", "ProcurementMatchingWorkspace",
  "ProcurementReportsWorkspace", "Run invoice match", "Add line",
]);
markers("src/app/api/procurement/resources/[resource]/[id]/route.ts", [
  "updateProcurementRecord", "PATCH", "tenantTransaction",
]);
markers("src/app/api/procurement/matching/run/route.ts", [
  "runProcurementMatch", "procurementMatchSchema", "tenantTransaction",
]);
markers("../../packages/shared-sdk/src/procurement.js", ["update:", "runMatch:"]);
...
console.log(`Procurement module verified across ${required.length} end-to-end contracts.`);
