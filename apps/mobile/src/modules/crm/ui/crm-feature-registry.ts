...
export const CRM_MOBILE_FEATURES: readonly CrmMobileFeature[] = [
  ...
  { id: "F006", label: "Lead qualification", group: "Customers", support: "web-workspace", description: "Commercial-readiness decisions.", webPath: "/crm/settings/playbooks" },
  { id: "F007", label: "Lead lifecycle", group: "Setup", support: "web-workspace", description: "Lifecycle stages and transitions.", webPath: "/crm/settings/lead-lifecycle" },
