...
export const CRM_MOBILE_FEATURES: readonly CrmMobileFeature[] = [
  ...
  { id: "F020", label: "Territories & sales teams", group: "Setup", support: "web-workspace", description: "Revenue ownership structure and coverage.", webPath: "/crm/settings" },
  { id: "F021", label: "Lead import & export", group: "Data", support: "web-workspace", description: "Governed CRM data movement.", webPath: "/crm/data-management" },
  ...
  { id: "F028", label: "Custom fields & tags", group: "Data", support: "web-workspace", description: "Adapt CRM records without fragmenting layouts.", webPath: "/crm/data-management" },
