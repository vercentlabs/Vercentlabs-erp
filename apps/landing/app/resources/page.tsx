    ...
    <>
      ...
      <Section tone="page">
        <Container>
          ...
          <Reveal group>
            <div className="mt-8 flex flex-col divide-y divide-(--color-border-default) border-t border-(--color-border-default)">
              <Link href="/resources/glossary" prefetch={false} className="group py-6" data-reveal-item>
                <Heading level="h3" className="group-hover:text-(--color-text-brand)">
                  ERP Glossary
                </Heading>
                <Text variant="body" className="mt-2 max-w-[70ch]">
              ...
              <Link href="/compare" prefetch={false} className="group py-6" data-reveal-item style={{ transitionDelay: "60ms" }}>
                <Heading level="h3" className="group-hover:text-(--color-text-brand)">
                  Compare Vercentlabs
                </Heading>
                <Text variant="body" className="mt-2 max-w-[70ch]">
