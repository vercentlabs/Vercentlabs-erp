...
D = ROOT/'docs'; R = D/'02-register'; SP = D/'04-shared-platform'; blockers = []
def rows(p):
...
if pm.returncode != 0: blockers.append('P0 sole-PM planning baseline invalid: ' + (pm.stdout + pm.stderr).strip().replace('\n',' | '))
...
print('Planning is closed, the sole-PM baseline is frozen, and architecture is frozen.')
print('Dependency-aware implementation may begin at T00 whenever the Project Manager chooses to begin.')
