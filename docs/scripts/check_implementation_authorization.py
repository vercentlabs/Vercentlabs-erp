...
if blockers:
    print('IMPLEMENTATION AUTHORIZATION: BLOCKED'); [print(' -',x) for x in blockers[:100]]; sys.exit(2)
print('IMPLEMENTATION AUTHORIZATION: PASS')
print('Planning is closed. Architecture is frozen. Dependency-aware implementation may begin at T00/T01.')
