# F070 — RFQ to multiple vendors — UAT
...
1. Sign in as an authorised user and verify the RFQ to multiple vendors workflow is reachable from the normal product UI, not only by direct API call.
