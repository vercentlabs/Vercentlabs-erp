# F049 — Delivery and shipment — UAT
...
1. Sign in as an authorised user and verify the Delivery and shipment workflow is reachable from the normal product UI, not only by direct API call.
