# F078 — Purchase agreements and contracts — UAT
...
1. Sign in as an authorised user and verify the Purchase agreements and contracts workflow is reachable from the normal product UI, not only by direct API call.
