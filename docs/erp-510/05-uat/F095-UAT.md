# F095 — Subcontract purchasing — UAT
...
1. Sign in as an authorised user and verify the Subcontract purchasing workflow is reachable from the normal product UI, not only by direct API call.
