# F033 — Products and services — UAT
...
1. Sign in as an authorised user and verify the Products and services workflow is reachable from the normal product UI, not only by direct API call.
