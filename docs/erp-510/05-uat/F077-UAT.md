# F077 — Blanket purchase orders — UAT
...
1. Sign in as an authorised user and verify the Blanket purchase orders workflow is reachable from the normal product UI, not only by direct API call.
