# F105 — Multi-warehouse inventory — UAT
...
1. Sign in as an authorised user and verify the Multi-warehouse inventory workflow is reachable from the normal product UI, not only by direct API call.
