# F106 — Real-time stock balance — UAT
...
1. Sign in as an authorised user and verify the Real-time stock balance workflow is reachable from the normal product UI, not only by direct API call.
