# F059 — Order status tracking — UAT
...
1. Sign in as an authorised user and verify the Order status tracking workflow is reachable from the normal product UI, not only by direct API call.
