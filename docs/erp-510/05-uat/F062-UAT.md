# F062 — Order-to-cash reporting — UAT
...
1. Sign in as an authorised user and verify the Order-to-cash reporting workflow is reachable from the normal product UI, not only by direct API call.
