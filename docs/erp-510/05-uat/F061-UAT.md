# F061 — Margin and profitability — UAT
...
1. Sign in as an authorised user and verify the Margin and profitability workflow is reachable from the normal product UI, not only by direct API call.
