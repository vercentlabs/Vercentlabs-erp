# F096 — Procurement dashboard — UAT
...
1. Sign in as an authorised user and verify the Procurement dashboard workflow is reachable from the normal product UI, not only by direct API call.
