# F055 — Credit notes and refunds — UAT
...
1. Sign in as an authorised user and verify the Credit notes and refunds workflow is reachable from the normal product UI, not only by direct API call.
