# F064 — Supplier contacts and addresses — UAT
...
1. Sign in as an authorised user and verify the Supplier contacts and addresses workflow is reachable from the normal product UI, not only by direct API call.
