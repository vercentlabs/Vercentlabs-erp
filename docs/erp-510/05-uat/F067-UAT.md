# F067 — Purchase requisitions — UAT
...
1. Sign in as an authorised user and verify the Purchase requisitions workflow is reachable from the normal product UI, not only by direct API call.
