# F028 — Custom fields and tags — UAT
...
1. Sign in as an authorised user and verify the Custom fields and tags workflow is reachable from the normal product UI, not only by direct API call.
