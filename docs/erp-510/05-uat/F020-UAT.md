# F020 — Territories and sales teams — UAT
...
1. Sign in as an authorised user and verify the Territories and sales teams workflow is reachable from the normal product UI, not only by direct API call.
