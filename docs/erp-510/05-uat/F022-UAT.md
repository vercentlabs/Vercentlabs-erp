# F022 — Lead-to-opportunity conversion — UAT
...
1. Sign in as an authorised user and verify the Lead-to-opportunity conversion workflow is reachable from the normal product UI, not only by direct API call.
