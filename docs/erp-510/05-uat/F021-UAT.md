# F021 — Lead import and export — UAT
...
1. Sign in as an authorised user and verify the Lead import and export workflow is reachable from the normal product UI, not only by direct API call.
