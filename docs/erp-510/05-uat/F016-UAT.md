# F016 — Follow-ups and reminders — UAT
...
1. Sign in as an authorised user and verify the Follow-ups and reminders workflow is reachable from the normal product UI, not only by direct API call.
