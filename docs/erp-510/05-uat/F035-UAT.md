# F035 — Customer-specific prices — UAT
...
1. Sign in as an authorised user and verify the Customer-specific prices workflow is reachable from the normal product UI, not only by direct API call.
