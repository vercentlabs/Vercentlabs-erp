# F104 — Warehouse locations and bins — UAT
...
1. Sign in as an authorised user and verify the Warehouse locations and bins workflow is reachable from the normal product UI, not only by direct API call.
