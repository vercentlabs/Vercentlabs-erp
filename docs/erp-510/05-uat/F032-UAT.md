# F032 — Customer addresses and contacts — UAT
...
1. Sign in as an authorised user and verify the Customer addresses and contacts workflow is reachable from the normal product UI, not only by direct API call.
