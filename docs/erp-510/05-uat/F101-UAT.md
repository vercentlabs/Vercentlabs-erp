# F101 — Multiple units of measure — UAT
...
1. Sign in as an authorised user and verify the Multiple units of measure workflow is reachable from the normal product UI, not only by direct API call.
