# F017 — Notes and attachments — UAT
...
1. Sign in as an authorised user and verify the Notes and attachments workflow is reachable from the normal product UI, not only by direct API call.
