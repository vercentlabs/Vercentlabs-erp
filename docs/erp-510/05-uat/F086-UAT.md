# F086 — 3-way matching: PO – GRN – Invoice — UAT
...
1. Sign in as an authorised user and verify the 3-way matching: PO – GRN – Invoice workflow is reachable from the normal product UI, not only by direct API call.
