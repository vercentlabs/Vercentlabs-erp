# F037 — Quotation versions and revisions — UAT
...
1. Sign in as an authorised user and verify the Quotation versions and revisions workflow is reachable from the normal product UI, not only by direct API call.
