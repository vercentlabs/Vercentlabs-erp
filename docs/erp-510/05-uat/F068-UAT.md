# F068 — Requisition approvals — UAT
...
1. Sign in as an authorised user and verify the Requisition approvals workflow is reachable from the normal product UI, not only by direct API call.
