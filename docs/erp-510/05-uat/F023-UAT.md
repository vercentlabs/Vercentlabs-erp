# F023 — Opportunity-to-quotation conversion — UAT
...
1. Sign in as an authorised user and verify the Opportunity-to-quotation conversion workflow is reachable from the normal product UI, not only by direct API call.
