# ERP-017 — Notes and attachments

## Status

- Feature ID: F017
- Module: CRM
- Feature: Notes and attachments
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the canonical CRM workflow while preserving the shared Activity, customer and opportunity records already used by adjacent CRM capabilities. This specification tracks the canonical requirement **F017 — Notes and attachments**.
