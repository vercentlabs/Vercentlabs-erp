# ERP-096 — Procurement dashboard

## Status

- Feature ID: F096
- Module: Procurement
- Feature: Procurement dashboard
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F096 — Procurement dashboard**.
