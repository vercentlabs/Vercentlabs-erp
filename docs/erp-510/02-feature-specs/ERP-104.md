# ERP-104 — Warehouse locations and bins

## Status

- Feature ID: F104
- Module: Stock
- Feature: Warehouse locations and bins
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the inventory system-of-record foundations for item setup, warehouses, balances, movements, reservations and promiseable availability. This specification tracks the canonical requirement **F104 — Warehouse locations and bins**.
