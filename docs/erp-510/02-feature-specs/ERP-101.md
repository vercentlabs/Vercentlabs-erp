# ERP-101 — Multiple units of measure

## Status

- Feature ID: F101
- Module: Stock
- Feature: Multiple units of measure
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the inventory system-of-record foundations for item setup, warehouses, balances, movements, reservations and promiseable availability. This specification tracks the canonical requirement **F101 — Multiple units of measure**.
