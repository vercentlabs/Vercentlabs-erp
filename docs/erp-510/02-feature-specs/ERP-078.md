# ERP-078 — Purchase agreements and contracts

## Status

- Feature ID: F078
- Module: Procurement
- Feature: Purchase agreements and contracts
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F078 — Purchase agreements and contracts**.
