# ERP-032 — Customer addresses and contacts

## Status

- Feature ID: F032
- Module: Sales
- Feature: Customer addresses and contacts
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the governed quotation-to-order-to-fulfilment-to-invoice workflow without duplicating customer, item, pricing, tax or accounting systems of record. This specification tracks the canonical requirement **F032 — Customer addresses and contacts**.
