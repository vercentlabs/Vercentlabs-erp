# ERP-109 — Goods issues

## Status

- Feature ID: F109
- Module: Stock
- Feature: Goods issues
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the inventory system-of-record foundations for item setup, warehouses, balances, movements, reservations and promiseable availability. This specification tracks the canonical requirement **F109 — Goods issues**.
