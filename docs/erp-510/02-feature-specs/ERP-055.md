# ERP-055 — Credit notes and refunds

## Status

- Feature ID: F055
- Module: Sales
- Feature: Credit notes and refunds
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the governed quotation-to-order-to-fulfilment-to-invoice workflow without duplicating customer, item, pricing, tax or accounting systems of record. This specification tracks the canonical requirement **F055 — Credit notes and refunds**.
...
- `tenant.sales_credit_adjustment_requests`
