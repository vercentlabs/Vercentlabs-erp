# ERP-064 — Supplier contacts and addresses

## Status

- Feature ID: F064
- Module: Procurement
- Feature: Supplier contacts and addresses
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F064 — Supplier contacts and addresses**.
