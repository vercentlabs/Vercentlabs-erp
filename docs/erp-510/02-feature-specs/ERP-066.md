# ERP-066 — Supplier categories

## Status

- Feature ID: F066
- Module: Procurement
- Feature: Supplier categories
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F066 — Supplier categories**.
