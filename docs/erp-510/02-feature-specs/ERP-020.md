# ERP-020 — Territories and sales teams

## Status

- Feature ID: F020
- Module: CRM
- Feature: Territories and sales teams
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the canonical CRM workflow while preserving the shared Activity, customer and opportunity records already used by adjacent CRM capabilities. This specification tracks the canonical requirement **F020 — Territories and sales teams**.
