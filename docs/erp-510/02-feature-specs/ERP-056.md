# ERP-056 — Drop shipping

## Status

- Feature ID: F056
- Module: Sales
- Feature: Drop shipping
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the governed quotation-to-order-to-fulfilment-to-invoice workflow without duplicating customer, item, pricing, tax or accounting systems of record. This specification tracks the canonical requirement **F056 — Drop shipping**.
...
- `tenant.sales_drop_ship_requests`
