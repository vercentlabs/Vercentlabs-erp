# ERP-091 — Supplier lead times

## Status

- Feature ID: F091
- Module: Procurement
- Feature: Supplier lead times
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F091 — Supplier lead times**.
...
- `tenant.procurement_supplier_lead_times`
