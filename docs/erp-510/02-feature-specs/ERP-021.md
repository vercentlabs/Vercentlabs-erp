# ERP-021 — Lead import and export

## Status

- Feature ID: F021
- Module: CRM
- Feature: Lead import and export
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the canonical CRM workflow while preserving the shared Activity, customer and opportunity records already used by adjacent CRM capabilities. This specification tracks the canonical requirement **F021 — Lead import and export**.
