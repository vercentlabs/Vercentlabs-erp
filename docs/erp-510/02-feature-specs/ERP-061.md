# ERP-061 — Margin and profitability

## Status

- Feature ID: F061
- Module: Sales
- Feature: Margin and profitability
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the governed quotation-to-order-to-fulfilment-to-invoice workflow without duplicating customer, item, pricing, tax or accounting systems of record. This specification tracks the canonical requirement **F061 — Margin and profitability**.
