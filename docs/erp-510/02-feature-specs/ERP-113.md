# ERP-113 — Available stock

## Status

- Feature ID: F113
- Module: Stock
- Feature: Available stock
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the inventory system-of-record foundations for item setup, warehouses, balances, movements, reservations and promiseable availability. This specification tracks the canonical requirement **F113 — Available stock**.
