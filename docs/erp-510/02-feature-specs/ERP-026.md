# ERP-026 — Won / lost reasons

## Status

- Feature ID: F026
- Module: CRM
- Feature: Won / lost reasons
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the canonical CRM workflow while preserving the shared Activity, customer and opportunity records already used by adjacent CRM capabilities. This specification tracks the canonical requirement **F026 — Won / lost reasons**.
