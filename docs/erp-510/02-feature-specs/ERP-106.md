# ERP-106 — Real-time stock balance

## Status

- Feature ID: F106
- Module: Stock
- Feature: Real-time stock balance
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the inventory system-of-record foundations for item setup, warehouses, balances, movements, reservations and promiseable availability. This specification tracks the canonical requirement **F106 — Real-time stock balance**.
