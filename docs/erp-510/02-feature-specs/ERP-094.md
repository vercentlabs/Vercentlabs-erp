# ERP-094 — Reorder-generated purchasing

## Status

- Feature ID: F094
- Module: Procurement
- Feature: Reorder-generated purchasing
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F094 — Reorder-generated purchasing**.
...
- `services/api/src/orchestration/reorder-purchasing.js`
- `tenant.procurement_reorder_requests`
