...
Complete the canonical CRM workflow while preserving the shared Activity, customer and opportunity records already used by adjacent CRM capabilities. This specification tracks the canonical requirement **F015 — Tasks**.
...
- `apps/web/src/app/api/crm/tasks/[id]/history/route.ts`
- `services/api/src/modules/crm/offline-sync.js`
