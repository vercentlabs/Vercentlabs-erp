# ERP-027 — Basic lead scoring

## Status

- Feature ID: F027
- Module: CRM
- Feature: Basic lead scoring
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the canonical CRM workflow while preserving the shared Activity, customer and opportunity records already used by adjacent CRM capabilities. This specification tracks the canonical requirement **F027 — Basic lead scoring**.
