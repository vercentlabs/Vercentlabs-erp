# ERP-085 — 2-way matching

## Status

- Feature ID: F085
- Module: Procurement
- Feature: 2-way matching
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F085 — 2-way matching**.
