# ERP-070 — RFQ to multiple vendors

## Status

- Feature ID: F070
- Module: Procurement
- Feature: RFQ to multiple vendors
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F070 — RFQ to multiple vendors**.
...
- `tenant.procurement_sourcing_invitations`
