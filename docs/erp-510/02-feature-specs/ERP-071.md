# ERP-071 — Supplier quotations

## Status

- Feature ID: F071
- Module: Procurement
- Feature: Supplier quotations
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F071 — Supplier quotations**.
...
- `tenant.procurement_sourcing_bids`
