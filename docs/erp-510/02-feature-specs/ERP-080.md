# ERP-080 — Goods receipt / GRN

## Status

- Feature ID: F080
- Module: Procurement
- Feature: Goods receipt / GRN
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F080 — Goods receipt / GRN**.
