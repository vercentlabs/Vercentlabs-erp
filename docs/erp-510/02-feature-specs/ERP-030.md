...
Complete the canonical CRM workflow while preserving the shared Activity, customer and opportunity records already used by adjacent CRM capabilities. This specification tracks the canonical requirement **F030 — CRM reports**.
