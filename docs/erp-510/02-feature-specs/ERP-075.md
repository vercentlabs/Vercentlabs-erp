# ERP-075 — PO approvals

## Status

- Feature ID: F075
- Module: Procurement
- Feature: PO approvals
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F075 — PO approvals**.
