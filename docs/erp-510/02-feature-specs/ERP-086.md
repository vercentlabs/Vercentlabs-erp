# ERP-086 — 3-way matching: PO – GRN – Invoice

## Status

- Feature ID: F086
- Module: Procurement
- Feature: 3-way matching: PO – GRN – Invoice
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete requisition-to-sourcing-to-PO-to-receipt-to-matching operations while preserving Procurement ownership of purchasing records and orchestration boundaries. This specification tracks the canonical requirement **F086 — 3-way matching: PO – GRN – Invoice**.
