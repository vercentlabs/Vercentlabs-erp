# ERP-052 — Advance payments

## Status

- Feature ID: F052
- Module: Sales
- Feature: Advance payments
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the governed quotation-to-order-to-fulfilment-to-invoice workflow without duplicating customer, item, pricing, tax or accounting systems of record. This specification tracks the canonical requirement **F052 — Advance payments**.
