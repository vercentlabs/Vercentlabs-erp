# ERP-023 — Opportunity-to-quotation conversion

## Status

- Feature ID: F023
- Module: CRM
- Feature: Opportunity-to-quotation conversion
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the canonical CRM workflow while preserving the shared Activity, customer and opportunity records already used by adjacent CRM capabilities. This specification tracks the canonical requirement **F023 — Opportunity-to-quotation conversion**.
