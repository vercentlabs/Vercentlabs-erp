# ERP-037 — Quotation versions and revisions

## Status

- Feature ID: F037
- Module: Sales
- Feature: Quotation versions and revisions
- Priority: P0
- Status: TESTING
- UAT: NOT_READY
- Pass: 1/5 (F015-F114)
...
Complete the governed quotation-to-order-to-fulfilment-to-invoice workflow without duplicating customer, item, pricing, tax or accounting systems of record. This specification tracks the canonical requirement **F037 — Quotation versions and revisions**.
