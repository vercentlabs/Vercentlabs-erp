...
Journey ID: `PRG-JRN-005`

Modules: Manufacturing;Quality;Stock / Inventory

Feature anchors: `F155;F156;F163;F164;F167;F181;F182;F312;F313;F314;F321;F322;F323;F324;F325`
...
|---:|---|---|---|---|
| 1 | Production trigger | Manufacturing | Inspection trigger/event | Inspection obligation |
| 2 | Inspection | Quality | Inspection result command | Immutable/correctable result |
| 3 | Hold gate | Quality;Stock / Inventory | Atomic hold predicate in movement transaction | Held quantity cannot move |
| 4 | Disposition | Quality | Release/rework/scrap/RTS/use-as-is | Authorized disposition |
| 5 | Stock consequence | Stock / Inventory | Owner movement command | Quantity/location/status truth |
| 6 | Reconcile | Manufacturing;Quality;Stock / Inventory | Traceability/reconciliation | Genealogy and quantities agree |
...
## Verification plan
- `PRG-JRN-005-E2E-01`: happy path across every owning module with visible, audit, stock and financial outcomes.
- `PRG-JRN-005-E2E-02`: permission/concurrency/validation failure proves no partial or cross-tenant state.
- `PRG-JRN-005-E2E-03`: retry, downstream uncertainty, reversal and reconciliation path proves exactly-once business effect.
- `PRG-JRN-005-UAT-01`: named business roles execute the primary journey from realistic prerequisites and sign off visible/data/audit outcomes.
- `PRG-JRN-005-UAT-02`: named business roles execute exception/recovery/reversal and confirm operational diagnostics/reconciliation.
