...
Journey ID: `PRG-JRN-004`

Modules: Manufacturing;Stock / Inventory;Quality;Accounting / Finance

Feature anchors: `F155;F156;F158;F159;F160;F161;F162;F163;F164;F166;F167;F168;F181;F182;F183;F184;F185`
...
|---:|---|---|---|---|
| 1 | Plan/MRP | Manufacturing | Planning/MRP commands | Demand-derived executable plan |
| 2 | Material reserve/issue | Manufacturing;Stock / Inventory | Stock reservation/issue | Traceable material consumption |
| 3 | Execute | Manufacturing | MO/work-order/job-card state machine | WIP/operation truth |
| 4 | Inspect/hold | Quality | Inspection + hold gate | Quality disposition truth |
| 5 | Finished receipt | Manufacturing;Stock / Inventory | FG receipt public contract | Available/held finished stock |
| 6 | Cost/reconcile | Manufacturing;Accounting / Finance | Costing/variance integration | Production cost reconciled |
...
## Verification plan
- `PRG-JRN-004-E2E-01`: happy path across every owning module with visible, audit, stock and financial outcomes.
- `PRG-JRN-004-E2E-02`: permission/concurrency/validation failure proves no partial or cross-tenant state.
- `PRG-JRN-004-E2E-03`: retry, downstream uncertainty, reversal and reconciliation path proves exactly-once business effect.
- `PRG-JRN-004-UAT-01`: named business roles execute the primary journey from realistic prerequisites and sign off visible/data/audit outcomes.
- `PRG-JRN-004-UAT-02`: named business roles execute exception/recovery/reversal and confirm operational diagnostics/reconciliation.
