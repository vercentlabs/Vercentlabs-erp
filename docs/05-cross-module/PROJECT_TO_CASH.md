...
Journey ID: `PRG-JRN-009`

Modules: Sales;Projects;Procurement;Stock / Inventory;HR & Payroll;Accounting / Finance

Feature anchors: `F193;F197;F198;F199;F208;F210;F211;F213;F214;F216;F217;F218;F219;F220;F221;F222`
...
|---:|---|---|---|---|
| 1 | Initiate | Sales;Projects | Order/opportunity-to-project contract | Authorized project |
| 2 | Plan/resource | Projects;HR & Payroll | WBS/milestone/resource plan | Baseline delivery plan |
| 3 | Capture cost | Projects;Procurement;Stock / Inventory;HR & Payroll | Time/expense/material/procurement contracts | Project actuals/commitments |
| 4 | Bill | Projects;Accounting / Finance | Fixed/T&M/milestone billing eligibility | Invoiceable amount |
| 5 | Recognize/reconcile | Projects;Accounting / Finance | Revenue/cost/profitability read model | Project margin reconciled |
| 6 | Close/reopen | Projects | Controlled close/reopen | No hidden unbilled/unposted exceptions |
...
## Verification plan
- `PRG-JRN-009-E2E-01`: happy path across every owning module with visible, audit, stock and financial outcomes.
- `PRG-JRN-009-E2E-02`: permission/concurrency/validation failure proves no partial or cross-tenant state.
- `PRG-JRN-009-E2E-03`: retry, downstream uncertainty, reversal and reconciliation path proves exactly-once business effect.
- `PRG-JRN-009-UAT-01`: named business roles execute the primary journey from realistic prerequisites and sign off visible/data/audit outcomes.
- `PRG-JRN-009-UAT-02`: named business roles execute exception/recovery/reversal and confirm operational diagnostics/reconciliation.
