...
Stock owns reorder/min-max/safety-stock evaluation and emits an idempotent replenishment request. Procurement owns supplier selection/RFQ/PO. Re-evaluation cannot create duplicate purchasing demand.
