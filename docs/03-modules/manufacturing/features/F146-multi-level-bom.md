...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Multi-level BOM** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F146-FR-001`, `F146-UX-001`, `F146-BR-001`, `F146-SEC-001`, `F146-AI-001`, `F146-INT-001`, `F146-E2E-001`.
