...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Material requirements** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F160-FR-001`, `F160-UX-001`, `F160-BR-001`, `F160-SEC-001`, `F160-AI-001`, `F160-INT-001`, `F160-E2E-001`.
