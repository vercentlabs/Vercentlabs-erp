...
- Curated authoritative benchmark IDs: `PFD-BM-F180-1`; `PFD-BM-F180-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Subcontract manufacturing**.
