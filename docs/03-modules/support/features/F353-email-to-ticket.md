...
- Curated authoritative benchmark IDs: `PFD-BM-F353-1`; `PFD-BM-F353-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Email-to-ticket**.
