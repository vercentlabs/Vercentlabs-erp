...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Automatic routing** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F352-FR-001`, `F352-UX-001`, `F352-BR-001`, `F352-SEC-001`, `F352-AI-001`, `F352-INT-001`, `F352-E2E-001`.
