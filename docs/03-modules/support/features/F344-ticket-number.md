...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Ticket number** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F344-FR-001`, `F344-UX-001`, `F344-BR-001`, `F344-SEC-001`, `F344-AI-001`, `F344-INT-001`, `F344-E2E-001`.
