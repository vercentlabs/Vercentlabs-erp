...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Attachments** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F358-FR-001`, `F358-UX-001`, `F358-BR-001`, `F358-SEC-001`, `F358-AI-001`, `F358-INT-001`, `F358-E2E-001`.
