...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **SLA reporting** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F378-FR-001`, `F378-UX-001`, `F378-BR-001`, `F378-SEC-001`, `F378-AI-001`, `F378-INT-001`, `F378-E2E-001`.
