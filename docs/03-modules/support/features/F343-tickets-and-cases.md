...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Tickets and cases** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F343-FR-001`, `F343-UX-001`, `F343-BR-001`, `F343-SEC-001`, `F343-AI-001`, `F343-INT-001`, `F343-E2E-001`.
