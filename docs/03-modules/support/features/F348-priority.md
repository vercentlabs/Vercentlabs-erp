...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Priority** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F348-FR-001`, `F348-UX-001`, `F348-BR-001`, `F348-SEC-001`, `F348-AI-001`, `F348-INT-001`, `F348-E2E-001`.
