...
- Curated authoritative benchmark IDs: `PFD-BM-F477-1`; `PFD-BM-F477-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Cash accounts**.
