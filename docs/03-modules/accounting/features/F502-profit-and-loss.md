...
- Curated authoritative benchmark IDs: `PFD-BM-F502-1`; `PFD-BM-F502-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Profit & Loss**.
