...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Supplier payment allocation** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F474-FR-001`, `F474-UX-001`, `F474-BR-001`, `F474-SEC-001`, `F474-AI-001`, `F474-INT-001`, `F474-E2E-001`.
