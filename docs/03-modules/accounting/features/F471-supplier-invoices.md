...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Supplier invoices** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F471-FR-001`, `F471-UX-001`, `F471-BR-001`, `F471-SEC-001`, `F471-AI-001`, `F471-INT-001`, `F471-E2E-001`.
