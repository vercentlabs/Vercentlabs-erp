...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **FX gains and losses** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F496-FR-001`, `F496-UX-001`, `F496-BR-001`, `F496-SEC-001`, `F496-AI-001`, `F496-INT-001`, `F496-E2E-001`.
