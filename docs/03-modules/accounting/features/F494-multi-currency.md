...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Multi-currency** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F494-FR-001`, `F494-UX-001`, `F494-BR-001`, `F494-SEC-001`, `F494-AI-001`, `F494-INT-001`, `F494-E2E-001`.
