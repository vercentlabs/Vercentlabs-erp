...
- `F337-SEM-01` — **Quality definition/inspection/nonconformance lifecycle**: Define specification/plan/inspection/result/hold/NCR/CAPA states and effectivity where applicable.
- `F337-SEM-02` — **Characteristic, sample, measurement, defect and evidence model**: Store units, precision, instrument, sample/lot, results, defects, documents and immutable correction history.
- `F337-SEM-03` — **Sampling, tolerance, pass/fail and disposition rules**: Specify deterministic acceptance, severity, sample selection, calibration validity, hold and disposition eligibility.
- `F337-SEM-04` — **Inspector/quality-manager authority and maker-checker**: Separate perform/review/release/use-as-is authority, protect controlled documents and scope by plant/site/quality team.
- `F337-SEM-05` — **Inspection, scan, exception, CAPA and audit workspace**: Support tablet/mobile capture, barcode/lot scan, offline boundary, queues, attachments, signatures/approvals and accessibility.
- `F337-SEM-06` — **Stock/manufacturing/procurement/support/assets contracts**: Quality holds must atomically block relevant stock/manufacturing commands; supplier/customer/calibration links use public contracts.
- `F337-SEM-07` — **Concurrent hold/release, correction, repeated disposition and instrument failure**: Handle races, duplicate results, invalid calibration, rework/scrap/RTS replay and controlled corrections.
- `F337-SEM-08` — **Tolerance/hold/race/traceability verification**: Require deterministic pass/fail tests, atomic hold race tests, genealogy, security negatives, E2E and UAT.
...
- Required flow IDs: `F337-PFC-01`, `F337-PFC-02`, `F337-PFC-03`, `F337-PFC-04`, `F337-PFC-05`, `F337-PFC-06`, `F337-PFC-07`, `F337-PFC-08`, `F337-PFC-09`, `F337-PFC-10`
- State transition IDs: `F337-STM-01`, `F337-STM-02`, `F337-STM-03`, `F337-STM-04`, `F337-STM-05`
...
- Curated authoritative benchmark IDs: `PFD-BM-F337-1`; `PFD-BM-F337-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Quality audits**.
