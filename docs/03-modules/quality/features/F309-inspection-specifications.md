...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Inspection specifications** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F309-FR-001`, `F309-UX-001`, `F309-BR-001`, `F309-SEC-001`, `F309-AI-001`, `F309-INT-001`, `F309-E2E-001`.
