...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Issues** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F224-FR-001`, `F224-UX-001`, `F224-BR-001`, `F224-SEC-001`, `F224-AI-001`, `F224-INT-001`, `F224-E2E-001`.
