...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Assignees** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F202-FR-001`, `F202-UX-001`, `F202-BR-001`, `F202-SEC-001`, `F202-AI-001`, `F202-INT-001`, `F202-E2E-001`.
