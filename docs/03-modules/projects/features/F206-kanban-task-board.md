...
- Curated authoritative benchmark IDs: `PFD-BM-F206-1`; `PFD-BM-F206-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Kanban / task board**.
