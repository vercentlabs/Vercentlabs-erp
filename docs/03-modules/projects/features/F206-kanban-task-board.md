...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Kanban / task board** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F206-FR-001`, `F206-UX-001`, `F206-BR-001`, `F206-SEC-001`, `F206-AI-001`, `F206-INT-001`, `F206-E2E-001`.
