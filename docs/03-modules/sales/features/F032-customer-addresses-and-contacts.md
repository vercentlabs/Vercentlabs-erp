...
- Curated authoritative benchmark IDs: `PFD-BM-F032-1`; `PFD-BM-F032-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Customer addresses and contacts**.
