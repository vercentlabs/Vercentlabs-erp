...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Availability check** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F045-FR-001`, `F045-UX-001`, `F045-BR-001`, `F045-SEC-001`, `F045-AI-001`, `F045-INT-001`, `F045-E2E-001`.
