...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Approval workflow** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F041-FR-001`, `F041-UX-001`, `F041-BR-001`, `F041-SEC-001`, `F041-AI-001`, `F041-INT-001`, `F041-E2E-001`.
