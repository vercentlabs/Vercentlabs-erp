...
- `F041-SEM-01` — **Decision request, eligibility and lifecycle**: Define trigger, candidate records, pending/approved/rejected/reassigned/escalated states and terminal/reopen behavior.
- `F041-SEM-02` — **Decision context, evidence, reason and delegation**: Store decision inputs, approver/assignee, reasons, evidence, effective time, delegation/escalation and immutable history.
- `F041-SEM-03` — **Deterministic routing, thresholds and precedence**: Define routing/ranking/eligibility rules, thresholds, calendars, fallback, overrides and tie-breaking.
- `F041-SEM-04` — **Authority, segregation of duties and override governance**: Block self-approval where prohibited, scope decisions by role/company/team and audit privileged overrides.
- `F041-SEM-05` — **Queue, action, explanation and exception experience**: Provide work queues, bulk-safe actions, reasons, SLA/age, conflict feedback, responsive/mobile approval and accessibility.
- `F041-SEM-06` — **Trigger and downstream side-effect contracts**: Define source event, public command, notifications, downstream state and exactly-once/reconciliation behavior.
- `F041-SEM-07` — **Race, withdrawal, supersession and retry recovery**: Handle simultaneous actors, changed source state, withdrawn request, duplicate job, retry and manual exception resolution.
- `F041-SEM-08` — **Decision audit and negative-path verification**: Require routing tests, SoD tests, concurrency tests, notification/outbox tests, E2E and UAT evidence.
...
- Required flow IDs: `F041-PFC-01`, `F041-PFC-02`, `F041-PFC-03`, `F041-PFC-04`, `F041-PFC-05`, `F041-PFC-06`, `F041-PFC-07`, `F041-PFC-08`, `F041-PFC-09`, `F041-PFC-10`
- State transition IDs: `F041-STM-01`, `F041-STM-02`, `F041-STM-03`, `F041-STM-04`, `F041-STM-05`
...
- Curated authoritative benchmark IDs: `PFD-BM-F041-1`; `PFD-BM-F041-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Approval workflow**.
