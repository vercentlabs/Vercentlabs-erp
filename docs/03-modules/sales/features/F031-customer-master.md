...
- Curated authoritative benchmark IDs: `PFD-BM-F031-1`; `PFD-BM-F031-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Customer master**.
