...
- Curated authoritative benchmark IDs: `PFD-BM-F054-1`; `PFD-BM-F054-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Customer returns**.
