...
- Curated authoritative benchmark IDs: `PFD-BM-F057-1`; `PFD-BM-F057-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Sales commissions**.
