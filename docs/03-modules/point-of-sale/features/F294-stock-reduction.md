...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Stock reduction** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F294-FR-001`, `F294-UX-001`, `F294-BR-001`, `F294-SEC-001`, `F294-AI-001`, `F294-INT-001`, `F294-E2E-001`.
