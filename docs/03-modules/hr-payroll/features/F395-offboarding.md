...
- Curated authoritative benchmark IDs: `PFD-BM-F395-1`; `PFD-BM-F395-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Offboarding**.
