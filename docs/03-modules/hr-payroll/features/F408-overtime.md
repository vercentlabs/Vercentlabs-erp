...
- `F408-SEM-01` — **Schedule/time/leave lifecycle and authoritative source**: Define planned, recorded, corrected, approved/locked states and authoritative time/leave balances.
- `F408-SEM-02` — **Shift, punch, calendar, leave and timezone model**: Store source/device, timezone, shift/calendar, punch intervals, leave periods, balances, approvals and correction lineage.
- `F408-SEM-03` — **Overlap, lateness, overtime, accrual and balance rules**: Define timezone/DST, duplicates, grace, overtime, accrual/proration, carry-forward, holiday and negative-balance policy.
- `F408-SEM-04` — **Employee/manager/HR approval and privacy boundaries**: Enforce self/manager/team scope, regularization/leave approval authority, SoD and sensitive attendance visibility.
- `F408-SEM-05` — **Employee/manager mobile-first time and leave workflow**: Cover check-in/out, requests, balances, calendar, approvals, corrections, offline/device states and accessibility.
- `F408-SEM-06` — **Payroll/project time and notification contracts**: Freeze approved snapshots consumed by payroll/projects; later corrections create explicit retro/reconciliation effects.
- `F408-SEM-07` — **Duplicate punch, overlap, offline replay and payroll-lock conflict**: Handle device replay, missing punch, concurrent approval, retro correction during locked payroll and exception queues.
- `F408-SEM-08` — **Temporal/property/payroll-snapshot verification**: Require DST/timezone tests, duplicate/replay tests, balance properties, payroll integration, E2E and UAT.
...
- Required flow IDs: `F408-PFC-01`, `F408-PFC-02`, `F408-PFC-03`, `F408-PFC-04`, `F408-PFC-05`, `F408-PFC-06`, `F408-PFC-07`, `F408-PFC-08`, `F408-PFC-09`, `F408-PFC-10`
- State transition IDs: `F408-STM-01`, `F408-STM-02`, `F408-STM-03`, `F408-STM-04`, `F408-STM-05`
...
- Curated authoritative benchmark IDs: `PFD-BM-F408-1`; `PFD-BM-F408-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Overtime**.
