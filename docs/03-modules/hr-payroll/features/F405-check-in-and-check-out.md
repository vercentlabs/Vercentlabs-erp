...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Check-in and check-out** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F405-FR-001`, `F405-UX-001`, `F405-BR-001`, `F405-SEC-001`, `F405-AI-001`, `F405-INT-001`, `F405-E2E-001`.
