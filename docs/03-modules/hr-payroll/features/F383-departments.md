...
- `F383-SEM-01` — **Definition, lifecycle and active/inactive semantics**: Define creation, uniqueness, lifecycle, effective use and archival without destroying historical references.
- `F383-SEM-02` — **Identity, hierarchy and reference integrity**: Freeze canonical identifiers, parent/child or classification relationships, required fields, deduplication and historical reference behavior.
- `F383-SEM-03` — **Defaults, precedence and effective dating**: Define configuration scope, defaults, overrides, precedence, future-dated changes and non-retroactive history.
- `F383-SEM-04` — **Administration and field-level authority**: Separate view/use/manage authority, sensitive fields, cross-company scope and unauthorized reference prevention.
- `F383-SEM-05` — **Search, selection, maintenance and bulk administration**: Cover list/search/select/create/edit/archive, bulk changes, imports, exports, conflicts and accessible responsive maintenance.
- `F383-SEM-06` — **Downstream consumption contract**: Define how dependent modules reference this configuration without duplicating ownership or mutating private tables.
- `F383-SEM-07` — **Deletion, merge, duplicate and stale-reference recovery**: Handle duplicate definitions, attempted delete-in-use, merge/remap where legal and deterministic operator errors.
- `F383-SEM-08` — **Audit, reporting and verification evidence**: Require before/after history, usage visibility, negative tests, migration tests and UAT proving downstream consistency.
...
- Required flow IDs: `F383-PFC-01`, `F383-PFC-02`, `F383-PFC-03`, `F383-PFC-04`, `F383-PFC-05`, `F383-PFC-06`, `F383-PFC-07`, `F383-PFC-08`, `F383-PFC-09`, `F383-PFC-10`
- State transition IDs: `F383-STM-01`, `F383-STM-02`, `F383-STM-03`, `F383-STM-04`, `F383-STM-05`
...
- Curated authoritative benchmark IDs: `PFD-BM-F383-1`; `PFD-BM-F383-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Departments**.
