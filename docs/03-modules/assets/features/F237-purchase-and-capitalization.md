...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Purchase and capitalization** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F237-FR-001`, `F237-UX-001`, `F237-BR-001`, `F237-SEC-001`, `F237-AI-001`, `F237-INT-001`, `F237-E2E-001`.
