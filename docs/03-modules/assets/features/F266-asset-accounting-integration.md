...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Asset accounting integration** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F266-FR-001`, `F266-UX-001`, `F266-BR-001`, `F266-SEC-001`, `F266-AI-001`, `F266-INT-001`, `F266-E2E-001`.
