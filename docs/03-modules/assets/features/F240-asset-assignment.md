...
- Curated authoritative benchmark IDs: `PFD-BM-F240-1`; `PFD-BM-F240-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Asset assignment**.
