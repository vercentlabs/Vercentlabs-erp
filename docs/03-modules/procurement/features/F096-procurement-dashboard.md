...
- Curated authoritative benchmark IDs: `PFD-BM-F096-1`; `PFD-BM-F096-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Procurement dashboard**.
