...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Rejected receipts** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F082-FR-001`, `F082-UX-001`, `F082-BR-001`, `F082-SEC-001`, `F082-AI-001`, `F082-INT-001`, `F082-E2E-001`.
