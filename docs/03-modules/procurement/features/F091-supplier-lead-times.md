...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Supplier lead times** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F091-FR-001`, `F091-UX-001`, `F091-BR-001`, `F091-SEC-001`, `F091-AI-001`, `F091-INT-001`, `F091-E2E-001`.
