...
- Curated authoritative benchmark IDs: `PFD-BM-F080-1`; `PFD-BM-F080-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Goods receipt / GRN**.
