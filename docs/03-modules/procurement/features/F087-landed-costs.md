...
- Curated authoritative benchmark IDs: `PFD-BM-F087-1`; `PFD-BM-F087-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Landed costs**.
