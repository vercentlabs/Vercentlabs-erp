...
- Curated authoritative benchmark IDs: `PFD-BM-F079-1`; `PFD-BM-F079-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Supplier price lists**.
