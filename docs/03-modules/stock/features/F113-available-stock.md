...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Available stock** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F113-FR-001`, `F113-UX-001`, `F113-BR-001`, `F113-SEC-001`, `F113-AI-001`, `F113-INT-001`, `F113-E2E-001`.
