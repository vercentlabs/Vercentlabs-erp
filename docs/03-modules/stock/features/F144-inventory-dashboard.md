...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Inventory dashboard** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F144-FR-001`, `F144-UX-001`, `F144-BR-001`, `F144-SEC-001`, `F144-AI-001`, `F144-INT-001`, `F144-E2E-001`.
