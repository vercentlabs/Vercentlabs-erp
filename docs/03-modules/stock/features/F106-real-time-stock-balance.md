...
- Curated authoritative benchmark IDs: `PFD-BM-F106-1`; `PFD-BM-F106-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Real-time stock balance**.
