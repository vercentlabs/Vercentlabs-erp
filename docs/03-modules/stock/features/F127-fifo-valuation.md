...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **FIFO valuation** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F127-FR-001`, `F127-UX-001`, `F127-BR-001`, `F127-SEC-001`, `F127-AI-001`, `F127-INT-001`, `F127-E2E-001`.
