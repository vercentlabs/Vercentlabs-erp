...
- Curated authoritative benchmark IDs: `PFD-BM-F143-1`; `PFD-BM-F143-2`
- The Pass D mappings are the implementation-planning benchmark authority for **Stock reports**.
