...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Cycle counting** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F120-FR-001`, `F120-UX-001`, `F120-BR-001`, `F120-SEC-001`, `F120-AI-001`, `F120-INT-001`, `F120-E2E-001`.
