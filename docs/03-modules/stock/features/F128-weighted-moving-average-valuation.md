...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Weighted / moving-average valuation** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F128-FR-001`, `F128-UX-001`, `F128-BR-001`, `F128-SEC-001`, `F128-AI-001`, `F128-INT-001`, `F128-E2E-001`.
