...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Internal transfers** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F110-FR-001`, `F110-UX-001`, `F110-BR-001`, `F110-SEC-001`, `F110-AI-001`, `F110-INT-001`, `F110-E2E-001`.
