...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Lead import and export** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F021-FR-001`, `F021-UX-001`, `F021-BR-001`, `F021-SEC-001`, `F021-AI-001`, `F021-INT-001`, `F021-E2E-001`.
