...
### Omission Gate
What would an experienced enterprise operator reasonably expect from **Notes and attachments** that the short canonical name does not explicitly say?

## 6. Sub-capabilities and requirements
Use nested traceability IDs such as `F017-FR-001`, `F017-UX-001`, `F017-BR-001`, `F017-SEC-001`, `F017-AI-001`, `F017-INT-001`, `F017-E2E-001`.
