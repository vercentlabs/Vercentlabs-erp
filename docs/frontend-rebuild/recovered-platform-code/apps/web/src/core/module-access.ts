...
// services/api/src/modules/crm/index.js, companyWhere() in procurement, etc.) is
...
import { requireApiWorkspace } from "@/core/auth";
...
// apps/web/src/core/billing.ts exactly, but returns a boolean instead of
