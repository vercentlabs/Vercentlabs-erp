...
export const CONTENT_FRESHNESS = Object.freeze({
  ...
  "/solutions/replace-spreadsheets": { publishedAt: "2026-08-07", lastModifiedAt: "2026-08-07", lastReviewedAt: "2026-08-07", reviewReason: "Added a distinct directDefinition field so the hero and direct-answer sections no longer repeat the same sentence." },
  "/solutions/connect-business-operations": { publishedAt: "2026-08-07", lastModifiedAt: "2026-08-07", lastReviewedAt: "2026-08-07", reviewReason: "Fixed a self-contradicting FAQ pair about Stock's integration status; added a distinct directDefinition." },
  "/solutions/multi-company-management": { publishedAt: "2026-08-07", lastModifiedAt: "2026-08-07", lastReviewedAt: "2026-08-07", reviewReason: "Re-anchored the problem framing to real ICP language (multi-facility manufacturer, multi-warehouse distributor); added a distinct directDefinition." },
  "/solutions/workflow-automation": { publishedAt: "2026-08-07", lastModifiedAt: "2026-08-07", lastReviewedAt: "2026-08-07", reviewReason: "Added a distinct directDefinition field." },
  "/solutions/real-time-business-reporting": { publishedAt: "2026-08-07", lastModifiedAt: "2026-08-07", lastReviewedAt: "2026-08-07", reviewReason: "Added a distinct directDefinition field." },
  ...
  "/workflows/order-to-fulfilment": { publishedAt: "2026-08-07", lastModifiedAt: "2026-08-07", lastReviewedAt: "2026-08-07", reviewReason: "Reworded to explicitly frame its warehouse/fulfilment angle as distinct from lead-to-cash's revenue-team angle; sequence trimmed to reduce step-text overlap." },
