/**
 * Platform module: search
 * Shared-platform capabilities: SP020
 ...
 * logic lands here.
 */
export const PLATFORM_MODULE = 'search' as const;
export const PLATFORM_MODULE_SP_IDS = ['SP020'] as const;
