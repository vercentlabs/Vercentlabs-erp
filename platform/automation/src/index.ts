/**
 * Platform module: automation
 * Shared-platform capabilities: SP013
 ...
 * logic lands here.
 */
export const PLATFORM_MODULE = 'automation' as const;
export const PLATFORM_MODULE_SP_IDS = ['SP013'] as const;
