...
const DOCUMENTED_EXCEPTIONS = {
  ...
  "api/billing/retry/route.ts": "Scheduler-only: there is no user session. Authenticated by the shared secret BILLING_CRON_SECRET (constant-time comparison; refused outright when the secret is unset). It only re-runs previously stored, previously signature-verified webhook events.",
